        ...
        <div className="place-content-center max-w-3xl p-4">
          ...
          <div className="flex">
            ...
            <p className="py-4 font-roboto">
              ...
              <div className="self-center pl-6 float-none md:float-right">
                ...
                <Image className="rounded-3xl shadow-xl overflow-hidden" src="/post/eportfolio/a-pure-pursuit/a-pure-pursuit-3.jpg" alt="Image" width={320} height={180}/>
          ...
          <div>
            ...
            <div className="self-center pr-6 pt-4 float-none md:float-left">
              <Image className="rounded-3xl shadow-xl overflow-hidden" src="/post/eportfolio/a-pure-pursuit/a-pure-pursuit-1.jpeg" alt="Image" width={360} height={180}/>
