        ...
        <div className="place-content-center max-w-3xl p-4">
          ...
          <div>
            <div className="self-center pl-6 pt-4 float-none md:float-right">
              <Image className="rounded-3xl shadow-xl overflow-hidden" src="/static/post/eportfolio/a-mission-is-all-you-need/Obsidian-sc.png" alt="Image" width={420} height={180}/>
